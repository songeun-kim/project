...
<body>
	...
	<section id="listPage">
		...
		<div method="get" action="boardWrite">
			<div class="container">
				<div class="row">
					...
					<div>
						...
						<div id="searchType">
							<select name="searchType">
								<option value="btitle"
									<c:if test="${searchType eq 'btitle'}">selected</c:if>>제목</option>
								<option value="bcontent"
									<c:if test="${searchType eq 'bcontent'}">selected</c:if>>내용</option>
								<option value="btitle_bcontent"
									<c:if test="${searchType eq 'btitle_bcontent'}">selected</c:if>>제목+내용</option>
								<option value="bid"
									<c:if test="${searchType eq 'bid'}">selected</c:if>>작성자</option>
							</select> 
							<input type="text" name="keyword" value="${keyword}" />

							<button type="button" id="searchBtn">검색</button>
						</div>
						<a href="boardWrite.html" class="btn btn-primary pull-right"
							type="submit">글쓰기</a>
					</div>
				</div>
			</div>
