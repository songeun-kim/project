...
<body>
    ...
    <section id="score_write">
        <div class="wrap">
            <form method="POST" action="/personal_score/score_update">
                ...
                <div id="formgroup">
                    <label>날짜선택</label>
                    <c:if test="${USER != null}">
                    <input type="text" id="datepicker" name="gameDate" value="${update.gameDate }">
                    </c:if>
                </div>
                <div id="formgroup">
                    <label>1게임</label>
                    <c:if test="${USER != null}">
                    <input type="text" class="formcontrol" id="score1" name="score1" value="${update.score1}">
                    </c:if>
                </div>
                <div id="formgroup">
                    <label>2게임</label>
                    <c:if test="${USER != null}">
                    <input type="text" class="formcontrol" id="score2" name="score2" value="${update.score2}" >
                    </c:if>
                </div>
                <div id="formgroup">
                    <label>3게임</label>
                    <c:if test="${USER != null}">
                    <input type="text" class="formcontrol" id="score3" name="score3" value="${update.score3 }" >
                    </c:if>
                </div>
                <div id="formgroup">
                    <label>오늘의 평균</label>
                    <c:if test="${USER != null}">
                    <input type="text" class="formcontrol" id="avg" name="avg" value="${update.avg }" onclick="avgVal()">
                    </c:if>
                </div>
                <div id="submit_btn">
